            ...
            success: function (data) {
                ...
                $.each(data, function (index, order) {
                    $(".content-table").append($("<tr>").append(
                        ...
                        $("<td>").text("₹" + order.price),
                        $("<td>").html($("<select>").attr('oid', order.id).html("<option selected disabled hidden>" + order.delivery_status + "</option> <option>Accepted</option> <option>Packed</option> <option>On The Way</option> <option>Delivered</option> <option>Cancel</option>")),
